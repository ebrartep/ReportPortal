...
function _process(args, ref) {
    ...
    return new Promise(function ($return, $error) {
        ...
        location = args[1];
        return fetch(("http://maps.googleapis.com/maps/api/geocode/json?address=" + location + "&sensor=false")).then(function ($await_1) {
            try {
                res = $await_1;
                return res.json().then(function ($await_2) {
                    try {
                        data = $await_2;
...
function map(opts) {
    var defaultOptions = {
        ...
        height: 300,
        gAuthKey: "",
        template: function template(args, options, ref, ref$1) {
            var mode = ref.mode;
            ...
            return new Promise(function ($return, $error) {
                var location = args[1];
                var base$$1 = "https://www.google.com/maps/embed/v1/" + mode + "?key=" + gAuthKey;
                var src;
                if (mode === "place") {
                ...
                return $return(withoutDetailsTemplate(src, height, id));
            });
        }
    };
    var pluginOptions = justExtend({}, defaultOptions, opts, {
...
//# sourceMappingURL=embed-plugin-map.js.map
